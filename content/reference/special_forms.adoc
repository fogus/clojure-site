...
The map destructuring form in the definition of `destr` above is functionally equivalent to the following declaration of `destr2` which highlights that associative destructuring has built-in support for keyword argument sequences:
