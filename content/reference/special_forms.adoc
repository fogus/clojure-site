...
The map __binding-form__ to the right of the `&` in `destr` is an associative destructuring __binding-form__ <<special_forms#associative-destructuring,detailed above>>. Calling `destr` to supply keyword arguments is as follows:
